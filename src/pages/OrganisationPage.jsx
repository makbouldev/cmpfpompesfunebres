function OrganisationPage() {
  const steps = [
    ...
    'Preparation de la ceremonie et reservation des intervenants.',
    'Organisation du transport et de la mise en sepulture.',
    'Suivi post-obseques et assistance pour les demarches restantes.',
  ]

  return (
    <section className="section">
      <div className="container">
        <h1>Organisation des obseques: etapes claires</h1>
