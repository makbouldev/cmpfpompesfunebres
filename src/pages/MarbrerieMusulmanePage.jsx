...
import imageHero from '../assets/muslimanes/1.png'
import imageOverlay from '../assets/muslimanes/2.webp'
import imageTeam from '../assets/muslimanes/3.webp'
import imageWorkshop from '../assets/muslimanes/4.webp'
        ...
        <div className="container mf-hero reveal-on-scroll">
          ...
          <div className="mf-hero-visual">
            <figure className="mf-hero-photo mf-hero-photo-main">
              <img src={imageHero} alt="Monument marbrerie musulmane CMPF" />
            </figure>
            <figure className="mf-hero-photo mf-hero-photo-overlay">
              <img src={imageOverlay} alt="Finition et gravure marbrerie musulmane CMPF" />
            </figure>
          </div>
        </div>
      </section>
